...
})(
  {
    ...
    whgv: [
      function(require, module, exports) {
        ...
        var M = {
            ...
            videoClassName: s.default.string,
            videoStyle: s.default.string,
            startTime: s.default.number,
            loop: s.default.bool,
            autoPlay: s.default.bool,
            src: s.default.string,
          ...
          R = (function(e) {
            ...
            function u(e) {
              ...
              return (
                ...
                (n.handleMouseMove = (0, T.throttle)(
                  ...
                  value: function(e) {
                    ...
                    var t = e.children,
                      ...
                      r = c.default.Children.toArray(
                        ...
                        return !(0, T.isVideoChild)(e);
                      }),
                      i = this.getDefaultChildren(t);
                    return (0, T.mergeAndSortChildren)(i, r, n);
                  },
                },
                {
                        ...
                        className: (0, f.default)(
                          {
                            ...
                            'video-react-user-inactive': !u,
                            'video-react-user-active': u,
    ...
    MN1a: [
      ...
      },
      {
        ...
        './constant': 'W4uV',
        './style.css': 'ICs2',
        '../node_modules/video-react/dist/video-react.css': 'ICs2',
      },
    ],
    uOLC: [
      function(require, module, exports) {
    ...
    A2T1: [
      function(require, module, exports) {
        ...
        var w = [o.default, n.default, r.default, a.default, l.default],
          k = [u.default, i.default, u.default, c.default, s.default],
          L = [
            '',
            ...
            return (
              ...
              E(r, [
                ...
                },
                {
                  ...
                  value: function() {
                    this.setState(function(e) {
                      return { index: (e.index + 1) % w.length };
                    });
                  },
                },
                {
                  ...
                  value: function() {
                    this.setState(function(e) {
                      return { index: (e.index + w.length - 1) % w.length };
                    });
                  },
                },
                {
                    ...
                    return (
                      this.state.isOpen &&
                        (n = e.default.createElement(t.default, {
                          mainSrc: w[this.state.index],
                          nextSrc: w[(this.state.index + 1) % w.length],
                          prevSrc:
                            w[(this.state.index + w.length - 1) % w.length],
                          mainSrcThumbnail: k[this.state.index],
                          nextSrcThumbnail:
                            k[(this.state.index + 1) % w.length],
                          prevSrcThumbnail:
                            k[(this.state.index + w.length - 1) % w.length],
...
//# sourceMappingURL=cats.19ab17e2.js.map
